...
*** Activate Evil
    ...
    (use-package evil
      ...
      (progn
        ...
        (setq evil-emacs-state-modes (append evil-emacs-state-modes '(sauron-mode ediff-mode org-agenda-mode jabber-roster twittering-mode dired-mode mu4e-main-mode mu4e-headers-mode mu4e-view-mode)))
