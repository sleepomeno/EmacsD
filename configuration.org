...
(use-package paredit
  ...
  (progn
    ...
    (define-key paredit-mode-map (kbd "C-c h") 'paredit-backward-slurp-sexp)
    (define-key paredit-mode-map (kbd "C-(") 'paredit-backward-slurp-sexp)
    (define-key paredit-mode-map (kbd "C-c j") 'paredit-backward-barf-sexp)
    (define-key paredit-mode-map (kbd "C-{") 'paredit-backward-barf-sexp)
    (define-key paredit-mode-map (kbd "C-c k") 'paredit-forward-barf-sexp)
    (define-key paredit-mode-map (kbd "C-}") 'paredit-forward-barf-sexp)
    (define-key paredit-mode-map (kbd "C-c l") 'paredit-forward-slurp-sexp)
...
*** Agenda
#+begin_src emacs-lisp 
(setq org-agenda-files (list "~/org/thesis.org" "~/org/cal.org" "~/org/bookmarks.org" "~/org/projects.org" "~/org/home.org" "~/org/uni.org" "~/org/french.org"))
